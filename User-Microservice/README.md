...
- In [TokenServic.cs](BusinessLogic/Implements/TokenService.cs), there 2 way of declare claim to `SecurityTokenDescriptor`. *Choose 1 only (Subject / Claims), if set both, Claims will override Subject [*reference](https://learn.microsoft.com/en-us/dotnet/api/microsoft.identitymodel.tokens.securitytokendescriptor?view=msal-web-dotnet-latest#properties)*
