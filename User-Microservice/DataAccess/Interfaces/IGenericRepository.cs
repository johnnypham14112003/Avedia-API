...
public interface IGenericRepository<T> where T : class
{
    ...
    /// <summary>
    ///     <![CDATA[Example:
    ///         AnyAsync(x => x.Name == "Xx");    => Check exist by condition
    ///     ]]>
    /// </summary>
    Task<bool> AnyAsync(Expression<Func<T, bool>> expression);
    /// <summary>
    ///     <![CDATA[Example:
    ///         CountAsync(x => x.Name == "Xx");    => Count by condition
    ///         CountAsync(x => true);              => Count all
    ///     ]]>
    /// </summary>
    ...
    /// <param name="asSplitQuery">Set "true" to increase performance when use Include more than 2 child-tables (1-N).</param>
