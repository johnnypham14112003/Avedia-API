## About
A microservice project of Avedia-API system using ASP.NET Core gRPC Service to manage data of Actor, Video, MetaData, Image using DbContext (Entity Framework O/RM)
